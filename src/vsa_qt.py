...
from data_layer import ParamsDSP, ParamsStreamUDP, do_hard_work, HDR_SZ
...
def on_spectrum(raw: np.ndarray, ema: Optional[np.ndarray], meta: Dict) -> None:
    # app.last_raw = raw.copy()
    # app.last_ema = None if ema is None else ema.copy()
    # app.last_meta = meta
    ...
