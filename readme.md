...
**ВАЖЛИВО**: аналзіує і виконує кластезіації не по кожноум бурсту, а по певному інтервалу в часі - будує батч ффт і оцінює його центр. Добре для оцінки хопінга.

Скрипт, який при першому запуску з файлом будує ватерфол всього файлу і грубо, дуже грубо, формує перелік сегментів (у часі) в яких бурсти лежать у одній частотній області.
Дозволяє оцінити частоний хопінг.
Повторний запуск з тими самими аргемунтами причзводитиь до вичтиуваня файлу з описом виявлених кластерів і ствренюю нових файлів у, яких будуть бурсти тілки на одній частоті. 
Може містити участки з бурстами на різних частотах, якщо вони потрпили в один сегмент батчу. Працює грубувато. 
...
Тонкі налаштуваня в тілі скрипта.
